# Programming Church
This repo contains a bunch of lesson startign in January 2018 for a little band of *'engineers from other disciplines'* (including my nieces) to learn software development and hardware device control using Python and Raspberry Pi
